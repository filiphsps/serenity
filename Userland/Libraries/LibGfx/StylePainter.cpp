...
void StylePainter::paint_tile(Painter& painter, IntRect const& rect, Palette const& palette, bool pressed, bool hovered, bool focused)
{
    current().paint_tile(painter, rect, palette, pressed, hovered, focused);
}
