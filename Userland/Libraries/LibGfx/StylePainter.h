...
public:
    ...
    virtual void paint_tile(Painter&, IntRect const&, Palette const&, bool pressed, bool hovered = false, bool focused = false) = 0;
...
public:
    ...
    static void paint_tile(Painter&, IntRect const&, Palette const&, bool pressed, bool hovered = false, bool focused = false);
