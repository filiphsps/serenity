...
private:
    ...
    virtual Messages::WindowServer::WindowTitleResponse window_title(i32) override;
    ...
    virtual Messages::WindowServer::WindowRectResponse window_rect(i32) override;
    virtual void set_window_minimum_size(i32, Gfx::IntSize) override;
    virtual Messages::WindowServer::WindowMinimumSizeResponse window_minimum_size(i32) override;
    virtual Messages::WindowServer::AppletRectOnScreenResponse applet_rect_on_screen(i32) override;
    ...
    virtual Messages::WindowServer::WallpaperResponse wallpaper() override;
    virtual Messages::WindowServer::SetScreenLayoutResponse set_screen_layout(ScreenLayout const&, bool) override;
    virtual Messages::WindowServer::ScreenLayoutResponse screen_layout() override;
    ...
    virtual Messages::WindowServer::WorkspaceSettingsResponse workspace_settings() override;
    ...
    virtual Messages::WindowServer::SystemThemeResponse system_theme() override;
    ...
    virtual Messages::WindowServer::SystemThemeOverrideResponse system_theme_override() override;
    ...
    virtual Messages::WindowServer::CursorHighlightRadiusResponse cursor_highlight_radius() override;
    virtual void set_cursor_highlight_color(Gfx::Color color) override;
    virtual Messages::WindowServer::CursorHighlightColorResponse cursor_highlight_color() override;
    virtual Messages::WindowServer::CursorThemeResponse cursor_theme() override;
    ...
    virtual Messages::WindowServer::GlobalCursorPositionResponse global_cursor_position() override;
    virtual void set_mouse_acceleration(float) override;
    virtual Messages::WindowServer::MouseAccelerationResponse mouse_acceleration() override;
    virtual void set_scroll_step_size(u32) override;
    virtual Messages::WindowServer::ScrollStepSizeResponse scroll_step_size() override;
    virtual Messages::WindowServer::ScreenBitmapResponse screen_bitmap(Optional<Gfx::IntRect> const&, Optional<u32> const&) override;
    virtual Messages::WindowServer::ScreenBitmapAroundCursorResponse screen_bitmap_around_cursor(Gfx::IntSize) override;
    virtual void set_double_click_speed(i32) override;
    virtual Messages::WindowServer::DoubleClickSpeedResponse double_click_speed() override;
    ...
    virtual Messages::WindowServer::DesktopDisplayScaleResponse desktop_display_scale(u32) override;
    virtual void set_flash_flush(bool) override;
    virtual void set_window_parent_from_client(i32, i32, i32) override;
    virtual Messages::WindowServer::WindowRectFromClientResponse window_rect_from_client(i32, i32) override;
    ...
    virtual Messages::WindowServer::ColorUnderCursorResponse color_under_cursor() override;
