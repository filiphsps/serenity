...
public:
    ...
    void set_desktop_scale_factor(float scale_factor) { m_desktop_scale_factor = scale_factor; }
    float desktop_scale_factor() const { return m_desktop_scale_factor; }
...
private:
    ...
    float m_desktop_scale_factor { 1 };
